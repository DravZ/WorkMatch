  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      description: 'Prestige Events Group accepted your application for Event Setup Crew.',
    ...
    },
    {
      id: '2',
      icon: '💬',
      title: 'New message from Metro Logistics',
      description: 'Hi Marcus, we have a new shift opening next Tuesday. Are you available?',
      category: 'Messages',
      timeAgo: '4 hours ago',
      isUnread: true,
    },
    {
      ...
      description: 'James K. left you a 5-star review for your work as Warehouse Picker.',
      category: 'Reviews',
      timeAgo: 'Yesterday',
      isUnread: false,
    },
    {
      ...
      description: 'Forklift Operator needed in Brooklyn — $26/hr, tomorrow 7am.',
      category: 'Jobs',
      timeAgo: 'Yesterday',
      isUnread: false,
    },
    {
      ...
      description: 'Your identity has been verified. Your profile now shows the verified badge.',
      category: 'System',
      timeAgo: '3 days ago',
      isUnread: false,
    },
